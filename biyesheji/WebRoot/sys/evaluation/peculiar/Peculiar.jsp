	    ...
	    <script type="text/javascript">
	      function chkVal(){
	         ...
	         if(grade==""||cla==""){
	           ...
	           frm.action="listPecScore.action";
	           frm.method="post";
	           frm.submit();
	         }
	      }
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
        <tr style="height:5%;">
		  <td valign="top" align="center">
            <table width="760" border="0" cellspacing="0" cellpadding="0" align="center" height="26">
               <tr><td valign="bottom" align="center"><b>特殊加分</b></td></tr>
        ...
        <tr>
	     ...
	     <tr>
            ...
            <iframe name="frmPec" src="" width="99%" height="99%" frameborder="0"></iframe>
          </td>
        </tr>
      </table>	   
    </body>
